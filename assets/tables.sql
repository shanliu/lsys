...
CREATE TABLE `yaf_rbac_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `yaf_rbac_role_user_id_IDX` (`user_id`,`status`,`priority`,`id`) USING BTREE,
  KEY `yaf_rbac_role_user_range_IDX` (`user_range`,`res_op_range`,`status`,`priority`,`id`) USING BTREE,
...
CREATE TABLE `yaf_rbac_role_op` (
  ...
  `change_time` bigint(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `yaf_rbac_role_op_IDX` (`role_id`,`res_op_id`,`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
...
CREATE TABLE `yaf_user_index` (
  ...
  PRIMARY KEY (`id`),
  KEY `yaf_user_index_cat` (`index_cat`,`index_data`,`status`) USING BTREE,
