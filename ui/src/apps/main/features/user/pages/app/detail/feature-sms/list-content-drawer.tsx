import { userSenderSmsMessageView, type UserSenderSmsMessageItemType } from '@shared/apis/user/sender-sms';
...
export function ListContentDrawer({
    ...
    const contentQuery = useQuery({
        queryKey: ['userSenderSmsMessageView', message.id],
        queryFn: async ({ signal }) => {
            return await userSenderSmsMessageView({ message_id: message.id }, { signal });
        },
        enabled: !!open,
        staleTime: 5 * 60 * 1000,
    });
        ...
        <Drawer open={open} onOpenChange={onOpenChange}>
            <DrawerContent>
                <DrawerHeader className={cn("pb-6")}>
                    <DrawerTitle className={cn("text-xl")}>短信详细信息</DrawerTitle>
                </DrawerHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col space-y-1">
                                ...
                                <span className="text-sm font-medium">{message.mobile || '-'}</span>
                            </div>
