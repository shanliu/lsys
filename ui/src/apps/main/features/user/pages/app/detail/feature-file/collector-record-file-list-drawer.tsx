...
interface CollectorRecordFileListDrawerProps {
    appId: number;
...
export function CollectorRecordFileListDrawer({
    appId,
    record,
    isOpen,
    onOpenChange,
}: CollectorRecordFileListDrawerProps) {
    ...
    return (
        <Drawer open={isOpen} onOpenChange={handleOpenChange}>
            <DrawerContent>
                <DrawerHeader>
                    <DrawerTitle>记录关联文件</DrawerTitle>
                ...
                <div className="mt-6 space-y-4 flex flex-col flex-1 min-h-0">
                    <div className="flex-1 overflow-y-auto space-y-3">
                        {isLoading ? (
                            ...
                            <div className="text-center text-muted-foreground py-8">暂无关联文件</div>
                        ) : (
                            files.map((file) => (
