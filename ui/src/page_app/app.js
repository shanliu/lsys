...
import { UserProvider } from '../common/context/session';
...
import { PageLayout } from './page/common/layout';
...
const SystemAppSmsSettingAlismsPage = React.lazy(() => import('./page/common/sender/sms/alisms'));
const SystemAppSmsSettingHwsmsPage = React.lazy(() => import('./page/common/sender/sms/hwsms'));
const SystemAppSmsSettingTensmsPage = React.lazy(() => import('./page/common/sender/sms/tensms'));
const SystemAppSmsSettingNeteasesmsPage = React.lazy(() => import('./page/common/sender/sms/neteasesms'));
const SystemAppSmsSettingCloOpensmsPage = React.lazy(() => import('./page/common/sender/sms/cloopensms'));
const SystemAppSmsSettingJdsmsPage = React.lazy(() => import('./page/common/sender/sms/jdsms'));
...
const SystemAppMailSettingSmtpPage = React.lazy(() => import('./page/common/sender/mail/smtp'));
