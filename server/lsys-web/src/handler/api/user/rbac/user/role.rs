...
#[derive(Debug, Deserialize)]
pub struct UserRoleEditParam {
    pub role_id: u64,
    pub role_key: String,
    pub role_name: String,
}

pub async fn user_role_edit(
    param: &UserRoleEditParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
    let role = req_dao
...
#[derive(Debug, Deserialize)]
pub struct UserRoleDelData {
    pub role_id: u64,
}

pub async fn user_role_del(
    param: &UserRoleDelData,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
...
pub async fn user_role_data(
    param: &UserRoleDataParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
    req_dao
...
#[derive(Debug, Deserialize)]
pub struct UserRolePermItemData {
    pub op_id: u64,
    pub res_id: u64,
}

#[derive(Debug, Deserialize)]
pub struct UserRolePermAddParam {
    pub role_id: u64,
    pub perm_data: Vec<UserRolePermItemData>,
}

pub async fn user_role_perm_add(
    param: &UserRolePermAddParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
...
#[derive(Debug, Deserialize)]
pub struct UserRolePermDelParam {
    pub role_id: u64,
    pub perm_data: Vec<UserRolePermItemData>,
}

pub async fn user_role_perm_del(
    param: &UserRolePermDelParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
...
#[derive(Debug, Deserialize)]
pub struct UserRolePermParam {
    pub role_id: u64,
    pub page: Option<PageParam>,
    pub count_num: Option<bool>,
}

pub async fn user_role_perm_data(
    param: &UserRolePermParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
...
#[derive(Debug, Deserialize)]
pub struct UserRoleUserAddParam {
    pub role_id: u64,
    pub user_data: Vec<RbacRoleUserItemData>,
}

pub async fn user_role_user_add(
    param: &UserRoleUserAddParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
...
#[derive(Debug, Deserialize)]
pub struct UserRoleUserDelParam {
    pub role_id: u64,
    pub user_data: Vec<u64>,
}

pub async fn user_role_user_del(
    param: &UserRoleUserDelParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
...
pub async fn user_role_user_data(
    param: &UserRoleUserParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    let auth_data = req_dao.user_session.read().await.get_session_data().await?;
