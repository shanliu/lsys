...
pub struct AppConfirmExterLoginFeatureParam {
    pub app_id: u64,
    pub confirm_status: i8,
    pub confirm_note: String,
}
// 通过能APP登录系统审核
pub async fn app_confirm_inner_feature_exter_login_confirm(
    param: &AppConfirmExterLoginFeatureParam,
...
pub struct AppConfirmExterSubAppParam {
    pub app_id: u64,
    pub confirm_status: i8,
    pub confirm_note: String,
}

pub async fn app_confirm_inner_feature_sub_app_confirm(
    param: &AppConfirmExterSubAppParam,
    req_dao: &UserAuthQueryDao,
) -> JsonResult<JsonData> {
    req_dao
        .web_dao
