...
CREATE TABLE `yaf_account_external` (
    ...
    `external_gender` varchar(8) NOT NULL DEFAULT '' COMMENT '性别',
    `external_link` varchar(255) NOT NULL DEFAULT '' COMMENT '其他网站用户链接',
...
CREATE TABLE `yaf_account_info` (
    ...
    `reg_ip` varchar(46) NOT NULL DEFAULT '' COMMENT '注册IP',
    `change_time` int unsigned NOT NULL DEFAULT 0 COMMENT '最后更改时间',
    PRIMARY KEY (`id`),
...
CREATE TABLE `yaf_account_login` (
    ...
    `login_ip` varchar(46) NOT NULL DEFAULT '' COMMENT '登陆者IP',
